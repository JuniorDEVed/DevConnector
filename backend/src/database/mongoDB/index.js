...
export const connectToMongoDB = async () => {
  try {
    ...
    Logger.info(
      `Mongo ☁ Cloud Atlas | ${mongoDB.mdbHost} | User: ${mongoDB.mdbUser} | Connection Established ✅`
    )
    ...
    Logger.info(
      'Mongoose connection error, if this is a fresh project maybe you forgot to set the env variables'
    )
    Logger.error(e)
  }
}